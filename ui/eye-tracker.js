    ...
    function update() {
        eyeContainers.forEach((svg) => {
            ...
            if (wrapper) {
                ...
                wrapper.style.setProperty('--pupil-x-1', `${state.currentX1.toFixed(2)}px`);
                wrapper.style.setProperty('--pupil-y-1', `${state.currentY1.toFixed(2)}px`);
                wrapper.style.setProperty('--pupil-x-2', `${state.currentX2.toFixed(2)}px`);
                wrapper.style.setProperty('--pupil-y-2', `${state.currentY2.toFixed(2)}px`);
            }
        });
