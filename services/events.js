...
export class EventManager {
  ...
  bindKeypadEvents() {
    ...
    keypad.addEventListener('click', (e) => {
      ...
      switch (action) {
        case 'digit':
          this.callbacks.onDigit(value);
          break;
        case 'op':
          this.callbacks.onOperation(value);
          break;
        case 'memory':
          this.callbacks.onMemory(value);
          break;
        case 'clear':
  ...
  bindSidebarEvents() {
    ...
    sidebar.addEventListener('click', (e) => {
      ...
      if (
        ...
        e.target.closest('#history-back-btn')
      ) {
    ...
    if (sciContainer) {
      sciContainer.addEventListener('input', () =>
  ...
  bindExternalUIEvents() {
    ...
    if (mobileBtn)
      mobileBtn.addEventListener('click', () => uiManager.toggleDrawer());
  ...
  handlePaste(text) {
    ...
    if (match) {
      ...
      if (this.calcDisplay) {
        ...
        setTimeout(() => {
          if (this.calcDisplay) this.calcDisplay.style.color = '';
        }, 300);
      }
